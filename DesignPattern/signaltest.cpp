...
void f1(int i) { std::cout << "f1:" << std::endl; sum += i; }
void f2(int i) noexcept { std::cout << "f2:" << std::endl; sum += 2*i; }
void f3(int i) noexcept { std::cout << "f3:" << std::endl; sum += 3 * i; }

struct s {
    static void s1(int i) { sum += i; }
    static void s2(int i) noexcept { sum += 2*i; }

    void f1(int i) { std::cout << "s.f1:" << std::endl; sum += i; }
    void f2(int i) const { std::cout << "s.f2:" << std::endl; sum += i; }
    void f3(int i) volatile { std::cout << "s.f3:" << std::endl; sum += i; }
    void f4(int i) const volatile { std::cout << "s.f4:" << std::endl; sum += i; }
    void f5(int i) noexcept { std::cout << "s.f5:" << std::endl; sum += i; }
    void f6(int i) const noexcept { std::cout << "s.f6:" << std::endl; sum += i; }
    void f7(int i) volatile noexcept { std::cout << "s.f7:" << std::endl; sum += i; }
    void f8(int i) const volatile noexcept { std::cout << "s.f8:" << std::endl; sum += i; }
};
...
void test_free_connection() {
    ...
    sig.connect(f3);
    //sig(1);
    std::cout << "test_free_connection sum:"<< sum << std::endl;

    //sigslot::connect(sig, f3);
    //sig(1);
    //std::cout << "test_free_connection sum:" << sum << std::endl;
...
void test_pmf_connection() {
    ...
    sig(1);
    std::cout << "test_pmf_connection sum:" << sum << std::endl;
}
...
void test_loop() {
    ...
    sigslot::connect(i1.sig(), &object<int>::set_val, &i2);

    i1.set_val(8);

    std::cout << "test_loop i1.val():" << i1.val() << std::endl;
    std::cout << "test_loop i2.val():" << i2.val() << std::endl;
